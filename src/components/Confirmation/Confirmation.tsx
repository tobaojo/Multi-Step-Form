...
const Confirmation = () => {
  return (
    <div className="flex flex-col space-y-6 mx-auto align-middle">
      ...
      <h1 className="font-bold text-marineBlue text-[1.8rem] justify-center text-center">Thank you!</h1>
      <p className="text-coolGray justify-center text-center text-[1.2rem]">
        Thanks for confirming your prescription!<br></br> We hope you have fun using pur
